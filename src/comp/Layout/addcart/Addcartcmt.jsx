...
import mat1 from "../img/material/mat/2.jpg";
        ...
        <div className="container" style={{ height:"80vh", width:"80%" ,}}>
            ...
            <div style={{display:"flex" , border:"solid #aabbaa", height:"500px", margin:"20px", justifyContent:"left"}}>
                ...
                <div style={{margin:"20px"}}>
                    <h4> Super Strong Cement -50Kgs </h4>
                    <p>
                    From Foundations to Skyscrapers, Our High-Quality Cement Mixes Are the Cornerstone of Durability and Reliability. Your Blueprint, Our Cement - Building Together for a Stronger Tomorrow! </p>
