...
import mat1 from "../img/material/mat/3.jpg";
        ...
        <div className="container" style={{ height:"80vh", width:"80%" ,}}>
            ...
            <div style={{display:"flex" , border:"solid #aabbaa", height:"500px", margin:"20px", justifyContent:"left"}}>
                ...
                <div style={{margin:"20px"}}>
                    <h4> Steel TMT Fe-500 Grade -32mm </h4>
                    <p>
                    Structures that Stand the Test of Time, Turn to Our Premium Steel! Elevate Your Projects with the Strength, Versatility, and Precision of Our Steel Products. Your Design, Our Steel - Building Excellence, One Beam at a Time! </p>
                    ...
                    <div>
                        ...
                        </div><span><p style={{fontSize:"12px", color:"#aa0000"}}>Minimum Order Qty : 50</p></span>
                    </div>
